...
def parse_hyperparams():
    ...
    parser.add_argument('-AR', '--adam_regularization', default=0, type=float, help="Regularization to use in ADAM optimizer")
...
def parse_args():
    ...
    # base folders
    parser.add_argument('-DF', '--data', default='./data/', type=str, help="Base folder where all data is stored")
    ...
    parser.add_argument('-DAT', '--date', default="11-23-22", type=str, help="The date"),
    parser.add_argument('-M',  '--model', default="HyperSINDy", type=str, help="Model to use")
    parser.add_argument('-DS', '--data_set', default="lorenz1", type=str, help="Which dataset to use (lorenz)")
