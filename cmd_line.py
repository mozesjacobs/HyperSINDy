...
def parse_args():
    ...
    # saving specifics
    parser.add_argument('-sess', '--session_name', default='trial1', type=str, help="Appended second to last part of file names")
    parser.add_argument('-DAT', '--date', default="10-27-22", type=str, help="The date"),
