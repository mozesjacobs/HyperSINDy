...
def parse_hyperparams():
    ...
    parser.add_argument('-E', '--epochs', default=301, type=float, help="Number of epochs to train for")
...
def parse_args():
    ...
    parser.add_argument('-TB', '--tensorboard_folder', default='./runs/drift_diff_2/', type=str, help="Output folder for tensorboard")
