...
#lorenz/state-after_scale-5.0/HyperSINDy/12-07-22/2/B-1.0_WD-0.001_T-0.1_TI-100_ND-25_HD-64_E-1001_LR-0.001_BS-250_AR-0_C-1.0/train
...
def parse_args():
    ...
    parser.add_argument('-DAT', '--date', default="12-19-22", type=str, help="The date"),
